...
namespace Bacchus.DataAccess.Migrations
{
    ...
    [Migration("20221230174229_supplier-wine-repository")]
    partial class supplierwinerepository
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Bacchus.Common.Entities.OrderWineEntity", b =>
                {
                    ...
                    b.HasOne("Bacchus.Common.Entities.OrderEntity", "Order")
                        .WithMany()
